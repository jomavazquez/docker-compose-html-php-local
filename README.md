...
- DOMAIN_NAME is the name you will need to write in the /etc/hosts file. Like www.elenacarrasco.test
...
- Let listenning port 80 if you execute "mysql-wordpress-nginx-local.yml",
